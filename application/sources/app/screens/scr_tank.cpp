...
//--------------THE COCONUT TREE------------------------------//
class CoconutTree //class cây dừa
{
public:
    int x;//vị trí mọc cây dừa trên đất
    ...
    void draw() {
        ...
        // WHITE: Màu sắc của hình ảnh.
        view_render.drawBitmap(x, 52 - 31, bitmap_coconutTree, 30, 31, WHITE);
    }
};
...
static CoconutTree my_coconutTree;//cây dừa
